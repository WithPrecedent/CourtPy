...
@dataclass
class Wranglers(object):
    """
    Container for holding data mungers used by CourtWrangler.
    """
    settings : object
    paths : object
    data_source : str
    ...
    def __post_init__(self):
        self.sources = {'party' : 'sec_party',
                        'docket' : 'sec_docket',
                        'cite' : 'sec_cite',
                        'notice' : 'sec_notice',
                        'future' : 'sec_future',
                        'counsel' : 'sec_counsel',
                        'disposition' : 'sec_disposition',
                        'author' : 'sec_author',
                        'panel_judges' : 'sec_panel_judges',
                        'separate' : 'sec_separate'}
